...
import { QueryOperation } from "./cocktailGridComponents";

export type CocktailGridContext<
 ...
 */
export function useCocktailGridContext<
  TQueryFnData = unknown,
  TError = DefaultError,
  TData = TQueryFnData,
  TQueryKey extends QueryKey = QueryKey,
>(
  _queryOptions?: Omit<
    ...
    "queryKey" | "queryFn"
  >,
): CocktailGridContext<TQueryFnData, TError, TData, TQueryKey> {
  return {
    fetcherOptions: {},
    queryOptions: {},
  };
